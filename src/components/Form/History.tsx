    ...
    return (
      ...
      >
        ...
        <div style={{ marginTop: '2rem' }}>
          <div style={{ margin: '-1rem', overflowX: 'auto', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
            <div style={{ display: 'inline-block', minWidth: '100%', padding: '0.5rem', verticalAlign: 'middle', paddingLeft: '1.5rem', paddingRight: '1.5rem' }}>
              <table style={{ minWidth: '100%', borderCollapse: 'collapse' }}>
                ...
                <tbody style={{ borderColor: '#d2d6dc', backgroundColor: '#303b4f' }}>
